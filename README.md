...
[![Модель запроса](https://infostart.ru/bitrix/templates/sandbox_empty/assets/tpl/abo/img/logo.svg)](https://infostart.ru/1c/articles/811832/)
...
Быстро сгенерировать код с использованием модели запроса можно в [Конструкторе модели запроса](https://infostart.ru/1c/articles/2639581/#%D0%BA%D0%BE%D0%BD%D1%81%D1%82%D1%80%D1%83%D0%BA%D1%82%D0%BE%D1%80-%D0%BC%D0%BE%D0%B4%D0%B5%D0%BB%D0%B8-%D0%B7%D0%B0%D0%BF%D1%80%D0%BE%D1%81%D0%B0). Интерактивный конструктор позволяет по тексту запроса получить код модели. Возможна и обратная операция - по коду модели получить текст запроса.

## Примеры работы

Больше примеров можно найти в статьях:
- ["Работа с моделью запроса"](https://infostart.ru/1c/articles/2639581/)
...
- Конфигурация (этот проект):
	- модуль библиотеки ```РаботаСМодельюЗапроса```
...
Объединить с файлом конфигурации из Демо-базы к статье [Работа с моделью запроса](https://infostart.ru/1c/articles/2639581/):
- Установить режим объединения с приоритетом в файле
