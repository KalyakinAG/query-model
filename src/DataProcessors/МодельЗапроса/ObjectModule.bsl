...
// 
// Возвращаемое значение:
//  ОбработкаОбъект.МодельЗапроса - Различные
...
// 
// Возвращаемое значение:
//  ОбработкаОбъект.МодельЗапроса - Первые
...
// 
// Возвращаемое значение:
//  ОбработкаОбъект.МодельЗапроса - Условие вхождения
Функция УсловиеВхождения(ИмяТаблицы, Поля = "*") Экспорт
	Возврат Условие(ВыражениеВхождения(ИмяТаблицы, Поля));
КонецФункции

// Применяется к условию в параметрах виртуальной таблицы.
// 
// Параметры:
//  Выражение - Строка - Выражение
// 
// Возвращаемое значение:
//  ОбработкаОбъект.МодельЗапроса - Условие
...
// Параметр виртуальной таблицы: Начало периода.
// 
// Параметры:
//  Значение - Строка - Значение даты, для параметра использовать &
// 
// Возвращаемое значение:
//  ОбработкаОбъект.МодельЗапроса - Начало периода
...
// Применяется для условия в связи. См. УсловиеВхождения
// 
